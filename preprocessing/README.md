...
The original dataset contains **multiple emotion labels per sentence**.
We convert it into a **binary classification task (positive vs negative)** and transform it into the format required by the original TextCNN implementation.
...
* Cleans the text
* Converts multi-label emotions into two classes: **positive** and **negative**
* Removes:

  * neutral samples
  * ambiguous samples
  * mixed samples (both positive and negative labels)
  * empty texts
  * duplicate texts
