...
def add_unknown_words(word_vecs, vocab, min_df=1, k=300):
    ...
    0.25 is chosen so the unknown vectors have approximately the same variance as pre-trained ones.
    """
    for word in vocab:
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python process_data.py GoogleNews-vectors-negative300.bin")
        sys.exit(1)
